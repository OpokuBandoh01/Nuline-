...
const inputClass = 'w-full rounded-xl border border-memo-line bg-memo-panel px-4 py-4 text-base text-memo-cream outline-none placeholder:text-memo-muted/70 focus:border-memo-gold'
    ...
    <main className="flex min-h-screen items-center justify-center bg-background px-6 text-foreground transition-colors duration-300">
      ...
      <section className="relative z-10 max-w-xl text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <button onClick={onRestart} className="w-full sm:w-auto rounded-full border border-memo-line hover:border-memo-gold px-6 py-3 text-sm text-memo-cream transition-colors">
            Create another magazine
          </button>
          <Link href="/admin" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-memo-gold px-6 py-3 text-sm font-semibold text-memo-ink hover:bg-memo-gold-light transition-colors">
